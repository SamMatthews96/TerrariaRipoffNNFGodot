...
//     public int XCoords => (int)Math.Round(Position.X / HostBlockManager.BlockSize);
//     public int YCoords => (int)Math.Round(Position.Y / HostBlockManager.BlockSize);
...
//         int xPosition = (int)Math.Round(mousePos.X / HostBlockManager.BlockSize);
//         int yPosition = (int)Math.Round(mousePos.Y / HostBlockManager.BlockSize);
