...
[Tool]
public partial class TestClass : Control {
	[Export] private RichTextLabel _typeName;

	[Export] private VBoxContainer _methodList;

	[Export] private CheckButton _showMethodsCheckButton;
	...
	public override void _EnterTree() {
		...
		_functions.Clear();
		_showMethodsCheckButton.Toggled += ToggleTestMethodsShow;
	}

	private void ToggleTestMethodsShow(bool isShow) {
		_methodList.Visible = isShow;
	}
